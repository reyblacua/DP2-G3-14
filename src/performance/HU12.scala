...
class HU12 extends Simulation {
	...
	object CannotAddAppointmentForInactiveHairdresser {
		val cannotAddAppointmentForInactiveHairdresser = exec(http("Show hairdresser")
			.get("/hairdressers/6")
			.headers(headers_0)
		).pause(5)
	}
	...
	val scn2 = scenario("Cannot create appointment for inactive hairdresser").exec(
		Home.home,
		Login2.login2,
		ShowHairdressers.showHairdressers,
		ShowHairdresser.showHairdresser,
		CannotAddAppointmentForInactiveHairdresser.cannotAddAppointmentForInactiveHairdresser
	)
